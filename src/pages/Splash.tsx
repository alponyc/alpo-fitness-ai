  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-6 px-8 text-center">
        {/* Logo */}
        <div className="w-28 h-28 rounded-2xl overflow-hidden border-2 border-primary/30 shadow-[0_0_40px_rgba(16,185,129,0.2)]">
          <img src={alpoLogo} alt="Alpo Fitness" className="w-full h-full object-cover" />
        </div>
        ...
        <p className="text-xs text-muted-foreground/70 max-w-[240px] leading-relaxed">
          Your intelligent fitness command center — powered by data, driven by results.
        </p>

        {/* Enter CTA */}
        <p className="text-[10px] uppercase tracking-[0.25em] text-primary/60 font-bold mt-4 animate-pulse">
